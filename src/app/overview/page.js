      ...
      <section className="grid grid-cols-[450px,450px,450px] grid-rows-[420px,420px] items-center justify-items-center justify-center gap-4 mb-20 ">
        <Link href={`/jouxli`}>
          <div className="relative h-[370px] w-[450px]  cursor-pointer group">
            ...
            <h2 className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-black text-2xl opacity-0 transition-opacity duration-300 group-hover:opacity-100">
              Jouxli
            </h2>
          </div>
        </Link>
